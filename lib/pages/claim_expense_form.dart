...
import 'package:expense_claims_app/blocs/claim_expense_bloc.dart';
...
class ClaimExpenseForm extends StatefulWidget {
  ClaimExpenseForm();

  @override
  _ClaimExpenseFormState createState() => _ClaimExpenseFormState();
}

class _ClaimExpenseFormState extends State<ClaimExpenseForm> {
  // Bloc
  ClaimExpenseBloc _expenseClaimBloc;
  ...
  void didChangeDependencies() {
    _expenseClaimBloc = Provider.of<ClaimExpenseBloc>(context);
  ...
  Widget _buildAttachmentList(Map<String, File> attachments,
      ClaimExpenseBloc claimExpenseBloc, BuildContext context) {
  ...
  void _selectAttachments(BuildContext context, ClaimExpenseBloc newOrderBloc,
      {String name}) async {
